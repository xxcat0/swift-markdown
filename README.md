...
This branch modified Package.swift file and adds [cmark-gfm](https://github.com/xxcat0/swift-cmark) (also forked) as local dependency to easily build the xcframework. Please remember to use `gfm` branch of `cmark` library to while building the framework by yourself. 
